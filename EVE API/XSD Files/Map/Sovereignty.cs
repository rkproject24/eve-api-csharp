...
public partial class eveapiResultRowsetRow {
    ...
    private string constellationSovereigntyField;
    
    private string sovereigntyLevelField;
    ...
    /// <remarks/>
    [System.Xml.Serialization.XmlAttributeAttribute()]
    public string constellationSovereignty {
        get {
            return this.constellationSovereigntyField;
        }
        set {
            this.constellationSovereigntyField = value;
        }
    }
    
    /// <remarks/>
    [System.Xml.Serialization.XmlAttributeAttribute()]
    public string sovereigntyLevel {
        get {
            return this.sovereigntyLevelField;
        }
        set {
            this.sovereigntyLevelField = value;
        }
    }
